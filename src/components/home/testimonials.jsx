...
const testimonials = [
  {
    ...
    role: "Entrepreneur",
    text: "From airport pickup to my hotel in Downtown Dubi, the service was seamless. The Ghost was immaculate and the chauffeur was highly professional.",
    rating: 5,
    location: "Dubi, UAE",
  ...
  },
  {
    ...
    rating: 5,
    location: "Business Bay, Dubi",
    image: "https://cdn-icons-png.flaticon.com/512/847/847969.png",
  },
  {
    name: "Mohammed Al Farsi",
    role: "Tourist",
    text: "We booked the Ghost for a Dubi city tour. Burj Khalifa, Marina, and Desert Safari — everything was covered in style. Truly worth it!",
    rating: 4.9,
    ...
    <section className="testimonials-section">
      <Container>
        <div className="section-header">
          ...
          <h2 className="main-heading">REAL STORIES, REAL EXPERIENCES</h2>
          <p className="description">
            Experience what our UAE clients say about our Rolls Royce chauffeur
            service.
          </p>
        </div>
                      ...
                      <span className="rating">
                        ...
                        {[...Array(1)].map((_, i) => (
                          <FaStar
                            key={i}
                            color={
                              i < Math.round(item.rating) ? "#FFD700" : "#555"
                            }
                          />
                        ))}
                      </span>
